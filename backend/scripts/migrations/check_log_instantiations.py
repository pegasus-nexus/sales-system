...
files_to_check = [
    ...
    "backend/app/application/services/excel_import_service.py",
    "backend/app/application/services/inventario_service.py",
    "backend/app/application/services/pedidos_service.py",
    "backend/app/application/services/sales_service.py",
...
for rel_path in files_to_check:
    ...
    for i, line in enumerate(lines):
        if "InventoryLog(" in line:
            # Print the line and the next 15 lines to see the arguments
            print(f"--- Line {i+1} ---")
