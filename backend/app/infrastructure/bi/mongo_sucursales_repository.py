...
class MongoSucursalesRepository:
    """
    Repositorio de lectura limpia para el Módulo de BI de Sucursales y Desempeño Operativo.
    Lee directamente las colecciones operacionales MongoDB: sales, sucursales.
    """
