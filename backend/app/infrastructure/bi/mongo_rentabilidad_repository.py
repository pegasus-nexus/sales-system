...
class MongoRentabilidadRepository:
    """
    Repositorio de lectura limpia para el Módulo de BI de Rentabilidad Teórica & Margen Bruto.
    ...
    async def get_products_dim(self, tenant_id: str) -> List[Dict[str, Any]]:
        ...
        for d in docs:
            res.append({
                ...
                "categoria_nombre": str(d.get("categoria_nombre") or "Sin Categoría"),
