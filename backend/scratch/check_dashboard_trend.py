...
async def test():
    ...
    # Parámetros idénticos a los del frontend
    tenant_id = "69cd7f0a8f3f6866d4cfbb62" # Tenant por defecto del sistema
    ...
    print(f"Total registros devueltos en la tendencia: {len(trend)}")
    
    # Sumar ingresos para la primera semana (1 de junio al 7 de junio)
    week_sum = 0
    week_tickets = 0
    for day in trend:
        # day["name"] es YYYY-MM-DD
    ...
    print(f"\nSuma total Tendencia de la Semana 1 (1 jun al 7 jun):")
