...
async def get_db_info():
    ...
    product_id = "6aac19c8231eec6c5b7bb132"
    ...
    for l in logs:
        print(f"Log: Suc: {l.get('sucursal_id')}, Almacen: {l.get('almacen_id')}, Tipo: {l.get('tipo_movimiento')}, Cantidad: {l.get('cantidad')}, Desc: {l.get('descripcion')}")
