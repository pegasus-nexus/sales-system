...
const ProtectedRoute = ({
  ...
  if (requiredFeature && !hasFeature(requiredFeature)) {
    // CAJERO/USER siempre pueden acceder a ventas, inventario y créditos sin importar el plan
    if (['CAJERO', 'USER'].includes(role ?? '') && ['VENTAS', 'INVENTARIO', 'CREDITOS'].includes(requiredFeature)) {
      return children;
    }
